        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section className="border-l-2 border-[#00D1FF]/30 pl-6 py-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                1.3. Просмотр Сайта не требует предоставления персональных данных. Персональные данные передаются Пользователем добровольно при заполнении форм на Сайте; отправляя форму, Пользователь даёт согласие на обработку персональных данных на условиях настоящей Политики.
              </p>
            </section>
            ...
            <section className="border-l-2 border-[#00D1FF]/30 pl-6 py-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                6.2. При использовании AI-интеграций и внешних сервисов (например, OpenAI API, Telegram Bot API), серверы которых могут находиться за пределами Российской Федерации, осуществляется трансграничная передача персональных данных. Такая передача производится с согласия Пользователя; обработка данных на стороне указанных сервисов регулируется их собственными политиками конфиденциальности.
              </p>
            </section>
